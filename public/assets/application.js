...
(function() {
  ...
  Motion = (function() {
    ...
    Motion.prototype.on = function(type, callback) {
      ...
      if (_(handlers).include(callback)) {
        return;
      }
      ...
      for (type in _ref) {
        ...
        _results.push((function() {
          ...
          for (_i = 0, _len = handlers.length; _i < _len; _i++) {
            handler = handlers[_i];
            _results1.push(MP.mediator.unsubscribe(type, handler));
          }
          return _results1;
        })());
      }
...
(function() {
  ...
  Player = (function(_super) {
    ...
    Player.prototype.save = function() {
      return MP.Socket.send('update', this.toJSON());
    };
...
(function() {
  ...
  Player = (function(_super) {
    ...
    function Player() {
      ...
      this.moveHoriz = __bind(this.moveHoriz, this);
      return Player.__super__.constructor.apply(this, arguments);
    }
    ...
    Player.prototype.moveHoriz = function() {
      return this.$el.css({
        left: this.model.get('current_x')
      });
    };

    Player.prototype.moveVert = function() {
      return this.$el.css({
        top: this.model.get('current_y')
      });
    };
